...
Route::namespace('Common')->group(function () {
    ...
    Route::prefix('common')->group(function () {
        ...
        Route::post('test-distance-matrix','CarMakeAndModelController@testDistanceMatrixApi');
        // Get car makes
        ...
        Route::middleware('auth')->group(function () {
            ...
            // List TripRequest
            Route::get('trip-request/list/{lat}/{lng}', 'TripRequestController@index');
            // Store TripRequest by users
            Route::post('trip-request/store', 'TripRequestController@store');
            // Delete TripRequest by User
            Route::post('trip-request/delete/{sos}', 'TripRequestController@delete');
