...
$user = auth()->user();
    ...
    private function calculateRideFares($distance_in_unit, $dropoff_time_in_seconds, $zone_type, $type_prices, $coupon_detail)
    {
        ...
        $discount_amount = 0;
        $coupon_applied_sub_total = $subtotal_price;
        ...
        if ($coupon_detail) {
            if ($coupon_detail->minimum_trip_amount < $subtotal_price) {
                ...
                $coupon_applied_sub_total = $coupon_applied_sub_total - $discount_amount;
            }
        }
        ...
        $total_price = $subtotal_price  + $without_discount_admin_commision;


        $discount_admin_commision = $service_fee;
